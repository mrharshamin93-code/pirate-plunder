...
# Keep the boot-splash stage enabled, but project.godot replaces the default Godot logo with Pirate's Plunder artwork.
...
Write-Host "Branded Pirate's Plunder splash enabled; no default Godot logo is used."
