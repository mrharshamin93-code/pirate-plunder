...
// Only lint authored source CSS. dist/.expo/web-build are generated build
// output (gitignored, regenerated by `expo export`) — linting them would
// just re-validate whatever bundler already produced, not our source.
